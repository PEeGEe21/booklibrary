...
const Footer = () => {
  ...
  return (
    <>
    <footer className="">
    <div className="bg-[#f7f7f7] dark:bg-gray-800 py-5 ">
        <div className="top-footer lg:flex container py-12">
            ...
            <div className="mt-6 lg:mt-0 lg:flex-1">
                <div className="grid grid-cols-2 gap-6 sm:grid-cols-3 md:grid-cols-4">
                    ...
                    <div>
                        <h3 className="text-gray-700 mb-5 uppercase dark:text-white">Legal</h3>
                    ...
                    <div>
                        <h3 className="text-gray-700 mb-5 uppercase dark:text-white">Contact Us</h3>
        ...
        <div className="container mx-auto py-10">
                    <div className="lg:flex items-center justify-between z-10 md:mb-0 z-10">
                            ...
                            <form className="rounded-md w-full flex items-center justify-center border border-gray-300 h-[50px]">
                                <input type="email" placeholder="Enter Your Email" className="text-sm h-full block w-full px-4 py-2 text-gray-700 bg-white border-0 border-gray-200 rounded-md dark:bg-gray-800 dark:text-gray-300  focus:outline-none" />
